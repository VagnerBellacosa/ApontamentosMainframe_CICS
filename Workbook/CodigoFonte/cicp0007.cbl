      ...
      * AMBIENTE    : ONLINE                                                    
      * FINALIDADE  : PROGRAMA CHAMADO VIA LOAD FLUXO DE COMUNICACAO            
      ******************************************************************        
      *                                                                         
      *------------------------                                               00
       IDENTIFICATION DIVISION.                                               00
      *------------------------                                               00
       PROGRAM-ID. CICP0007.                                                  00
      *---------------------                                                  00
      ...
      *-------------------                                                    00
           ...
           DISPLAY '********************************************'               
           DISPLAY '* PROGRAMA CICP0007                        *'               
           DISPLAY '* CHAMADA VIA XCTL DO PROGRAMA CICP0006    *'               
           DISPLAY '*                                          *'               
           DISPLAY '********************************************'.              
                                                                                
           MOVE 'CHEGUEI NO CICP0007     ' TO LNK-MSG.                          
           ...
           MOVE 'FUI EMBORA VOLTEI AO 006' TO LNK-MSG.                          
