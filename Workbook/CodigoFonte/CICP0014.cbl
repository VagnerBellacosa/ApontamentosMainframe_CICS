      ...
      * AMBIENTE    : ONLINE                                                    
      * FINALIDADE  : INSERE NOVO ALUNOS E EXIBE NA TELA                        
      ...
      *----                                                                   00
       01  MAPA                      PIC  X(008) VALUE 'MAPS009 '.            00
      ...
      *-------------------                                                    00
       ...
       ROT-PRINCIPAL               SECTION.                                     
           ...
           DISPLAY '    '                                                       
           DISPLAY '********************************************'               
           DISPLAY '* PROGRAMA CICP0014                        *'               
           DISPLAY '* RECEBE MATRICULA PESQUISA ALUNO NO VSAM *'                
      ...
      *----                                                                   00
           EVALUATE EIBAID                                                    00
               ...
               WHEN  DFHPF2                                                   00
                     PERFORM 4100-VALIDA-ALUNO                                  
                     PERFORM 4200-CRIAR-ALUNO                              00   
                     MOVE 'REGISTRO CRIADO.' TO MSGERROO                   00   
      ...
      *----                                                                   00
       ...
       4000-SALVA-ARQUIVO-EXIT.                                               00
           EXIT.                                                                
      ******************************************************************      00
      * ROTINA PARA VALIDAR ALUNO ANTES DE GRAVAR NO VSAM                     00
      ******************************************************************      00
       4100-VALIDA-ALUNO.                                                       
           DISPLAY '4100-VALIDA-ALUNO'                                          
                                                                                
           IF ALUNOI EQUAL SPACES OR ZEROES                                     
              DISPLAY ' ALUNO INVALIDO ' ALUNOI                                 
              MOVE 'ALUNO INVALIDO ' TO COMANDO                               00
              MOVE MSG-ERRO TO MSGERROO                                       00
              PERFORM 0200-ROTINA-SEND                                        00
              PERFORM  1000-FIM                                               00
           END-IF.                                                              
                                                                                
           IF SEXOI   EQUAL SPACES                                              
              DISPLAY ' SEXO INVALIDO ' SEXOI                                   
              MOVE 'SEXO INVALIDO ' TO COMANDO                                00
              MOVE MSG-ERRO TO MSGERROO                                       00
              PERFORM 0200-ROTINA-SEND                                        00
              PERFORM  1000-FIM                                               00
           ELSE                                                                 
              IF SEXOI NOT EQUAL 'M' AND 'F'                                    
                DISPLAY ' PREENCHA [M] OU [F] ' SEXOI                           
                MOVE ' PREENCHA [M] OU [F] ' TO COMANDO                       00
                MOVE MSG-ERRO TO MSGERROO                                     00
                PERFORM 0200-ROTINA-SEND                                      00
                PERFORM  1000-FIM                                             00
              END-IF                                                            
           ...
           IF NOTA01I NOT NUMERIC                                               
              DISPLAY ' NOTA NUMERO 1 COM ERRO ' NOTA01I                        
              MOVE 'NOTA01 INVALIDA ' TO COMANDO                              00
              MOVE MSG-ERRO TO MSGERROO                                       00
              PERFORM 0200-ROTINA-SEND                                        00
              PERFORM  1000-FIM                                               00
           END-IF.                                                              
                                                                                
           IF NOTA02I NOT NUMERIC                                               
              DISPLAY ' NOTA NUMERO 2 COM ERRO ' NOTA02I                        
              MOVE 'NOTA02 INVALIDA ' TO COMANDO                              00
              MOVE MSG-ERRO TO MSGERROO                                       00
              PERFORM 0200-ROTINA-SEND                                        00
              PERFORM  1000-FIM                                               00
           END-IF.                                                              
                                                                                
           IF NOTA03I NOT NUMERIC                                               
              DISPLAY ' NOTA NUMERO 3 COM ERRO ' NOTA03I                        
              MOVE 'NOTA03 INVALIDA ' TO COMANDO                              00
              MOVE MSG-ERRO TO MSGERROO                                       00
              PERFORM 0200-ROTINA-SEND                                        00
              PERFORM  1000-FIM                                               00
           END-IF.                                                              
                                                                                
           IF NOTA04I NOT NUMERIC                                               
              DISPLAY ' NOTA NUMERO 4 COM ERRO ' NOTA04I                        
              MOVE 'NOTA04 INVALIDA ' TO COMANDO                              00
              MOVE MSG-ERRO TO MSGERROO                                       00
              PERFORM 0200-ROTINA-SEND                                        00
              PERFORM  1000-FIM                                               00
           END-IF.                                                              
                                                                                
           IF NOTA05I NOT NUMERIC                                               
              DISPLAY ' NOTA NUMERO 5 COM ERRO ' NOTA05I                        
              MOVE 'NOTA05 INVALIDA ' TO COMANDO                              00
              MOVE MSG-ERRO TO MSGERROO                                       00
              PERFORM 0200-ROTINA-SEND                                        00
              PERFORM  1000-FIM                                               00
           END-IF.                                                              
       ...
       4150-BUSCA-ALUNO.                                                        
           ...
           IF RESP1  NOT EQUAL DFHRESP(NORMAL)                                  
             DISPLAY 'ERRO NA REGRAVACAO : MATRIC = ' MATRICI                   
           END-IF.                                                              
                                                                                
      ******************************************************************      00
      * ROTINA PARA CRIAR NOVO ALUNO NO VSAM                                  00
      ******************************************************************      00
       4200-CRIAR-ALUNO.                                                      00
                                                                                
           DISPLAY '4200-CRIAR-ALUNO'.                                          
           ...
           DISPLAY 'NOVO ALUNO'                                                 
              ...
              MOVE MATRICI   TO          MATRICULA                            00
              MOVE ALUNOI    TO          NOME                                 00
              MOVE SEXOI     TO          SEXO                                 00
              MOVE NOTA01I   TO          NOTA01                               00
              MOVE NOTA02I   TO          NOTA02                               00
              MOVE NOTA03I   TO          NOTA03                               00
              MOVE NOTA04I   TO          NOTA04                               00
              MOVE NOTA05I   TO          NOTA05                               00
           ...
           END-IF                                                             00
      *----                                                                   00
           DISPLAY ' ANTES DO ERRO DO WRITE'                                    
           DISPLAY ' MATRICULA  = '  MATRICULA                                  
           DISPLAY ' NOME       = '  NOME                                       
           DISPLAY ' SEXO       = '  SEXO                                       
           DISPLAY ' NOTA01     = '  NOTA01                                     
           ...
           DISPLAY ' SITUACAO   = '  SITUACAO                                   
      *----                                                                   00
           EXEC CICS WRITE FILE(ARQ-VSAM)                                     00
                           FROM(REGISTRO-VSAM)                                00
                           LENGTH(LENGTH OF REGISTRO-VSAM)                    00
                           RIDFLD(MATRICULA)                                    
                           RESP(RESP1)                                        00
      ...
      *----                                                                   00
           ...
           IF RESP1 NOT EQUAL DFHRESP(NORMAL)                                 00
              DISPLAY ' ERRO NO VSAM WRITE -> RESP1= ' RESP1                    
                      ' RESP2 = ' RESP2                                         
              MOVE 'WRITE ' TO COMANDO                                        00
              MOVE MSG-ERRO TO MSGERROO                                       00
              PERFORM 0200-ROTINA-SEND                                        00
              PERFORM  1000-FIM                                               00
           END-IF.                                                            00
